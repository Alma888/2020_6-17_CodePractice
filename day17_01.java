...
//     一共N辆火车，每辆火车以数字1-9编号。要求以字典序排序输出火车出站
//     的序列号。
// 【输入描述】：有多组测试用例，每一组第一行输入一个正整数
//                          N（0<N<10），第二行包括N个正整数，范围为1到9。
// 【输出描述】：输出以字典序从小到大排序的火车出站序列号，每个编号以空
//                          格隔开，每个输出序列换行，具体见sample。
// 【示例1】:输入  3
//                           1 2 3
//                  输出  1 2 3
//                           1 3 2
...
public class day17_01 {
    public static void main(String[] args) {
        ...
        while(in.hasNext()){
            int n = in.nextInt();//输入火车数量
            int[] A = new int[n];//输入火车编号
            for(int i=0;i<n;i++){
                A[i] = in.nextInt();
            }
            int start = 0;
